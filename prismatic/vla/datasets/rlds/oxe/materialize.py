...
def make_oxe_dataset_kwargs(
    ...
    if dataset_kwargs["action_encoding"] not in [ActionEncoding.EEF_POS, ActionEncoding.EEF_R6, ActionEncoding.POS_EULER_HAND]:
        raise ValueError(f"Cannot load `{dataset_name}`; only EEF_POS & EEF_R6 & POS_EULER_HAND actions supported!")
    ...
    elif dataset_kwargs["action_encoding"] is ActionEncoding.POS_EULER_HAND:
        dataset_kwargs["absolute_action_mask"] = [False] * 24 
        dataset_kwargs["action_normalization_mask"] = [True] * 24 
